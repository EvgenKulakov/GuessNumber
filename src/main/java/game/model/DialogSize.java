...
public enum DialogSize {
    ...
    FIRST_SIZE(132.8000030517578, 271.5, 320.0),
    SECOND_SIZE(112.80000305175781, 271.5, 360.0),
    THIRD_SIZE(112.80000305175781, 265.9000015258789, 360),
    FOURTH_SIZE(74.39999389648438, 257.5, 360.0);
